                ...
                <div class="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
							...
							$MATRICULE = $_GET["MATRICULE"];
							  ...
							  try
							     ...
							     catch(Exception $e)
							     {
							      ...
							      $result = $db->query("SELECT * FROM AFFECTER WHERE MATRICULE = $MATRICULE");
							...
							<div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">DateDebAff<span class="required"/>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                            <input  class="form-control col-md-7 col-xs-12" name="DATEDEBAFF" size="22" value="<?php echo ''.$affiche_commentaire["DATEDEBAFF"].'
							 ';?>" type="text"/ >
                            </div>
                            </div>  
							 
							<div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">DateFinAff<span class="required"/>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                            <input  class="form-control col-md-7 col-xs-12" name="DATEFINAFF" size="22" value="<?php echo ''.$affiche_commentaire["DATEFINAFF"].' 
							';?>" type="text"/ >
                            </div>
                            </div>   
							...
							if(isset($_POST["Modifier"]))
								...
								$DATEDEBAFF = $_POST["DATEDEBAFF"];
								$DATEFINAFF = $_POST["DATEFINAFF"];
								$requete="UPDATE affecter set MATRICULE='$MATRICULE',NUMINVENTAIRE='$NUMINVENTAIRE',DATEDEBAFF='$DATEDEBAFF',DATEFINAFF='$DATEFINAFF' where MATRICULE='$MATRICULE'";
								...
								?>
									<?php
									sleep(0);
									header('Location:ListeAffectaion.php');
									?>
								<?php
								}
							$result->closeCursor();
