                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
							...
							$ID = $_GET["ID"];
							  ...
							  try
							     ...
							     catch(Exception $e)
							     {
							      ...
							      $result = $db->query("SELECT * FROM MAINTENEUR WHERE ID = $ID");
							...
							if(isset($_POST["Modifier"]))
								...
								$requete="UPDATE MAINTENEUR set ID='$ID',NOMMAINTENEUR='$NOMMAINTENEUR',ADRESSE='$ADRESSE',CODEPOSTAL='$CODEPOSTAL',VILLE='$VILLE',TEL='$TEL',EMAIL='$EMAIL' where ID='$ID'";
								...
								?>
									<?php
									sleep(0);
									header('Location:GestionMainteneur.php');
									?>
								<?php
								}
							$result->closeCursor();
