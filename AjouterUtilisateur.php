                   ...
                   Ajouter Utilisateur
                    ...
                    <div class="row">
                                ...
                                <div class="x_content">
                                    ...
                                    <form action="AjouterUtilisateur1.php" class="form-horizontal form-label-left" novalidate>

                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Matricule <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="Matricule" class="form-control col-md-7 col-xs-12"  name="Matricule"  required="required" type="text">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="email">Poste utilisateur<span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
												<?php
               									 try
                									...
                									$reponse = $db->query('SELECT * FROM POSTEUTILISATEUR;');
                									?>
                									<select  id="NomPoste" type="text" name="NomPoste"  class="optional form-control col-md-7 col-xs-12">
                									<?php 
                									while ($donnees = $reponse->fetch(PDO::FETCH_ASSOC))
                									{
                									?>
                									<option><?php echo $donnees['NOMPOSTE'];?></option>
                                        ...
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="email">Nom <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="Nom" id="text" name="Nom"  required="required" class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="number">Prenom <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="occupation">Telephone <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="Tel" type="number" name="Tel"  class="optional form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label for="password" class="control-label col-md-3">Email</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="Email" type="text" name="Email"  class="form-control col-md-7 col-xs-12" required="required">
                                            </div>
                                        </div>
