                                        ...
                                        <tbody>
                                          <?php
        										...
        										$reponse = $db->query($sql);
                									...
                									<td>
                									<form method="post" action="GestionFournisseur.php">
                									<input type="image" name="sup" value="<?php echo $donnees['ID']; ?>" src="images/del.png" />
                									</form>
                          							<td><?php echo '<a style="color:#0000FF;" href="ModifierFournisseur.php?ID='.$donnees['ID'].'">'; ?> Modifier</a></td>
                									
                									
                									<?php
 													   if (isset($_POST['sup'])) {
    												   $db->query("DELETE  FROM FOURNISSEUR WHERE ID =".$_POST['sup']);
    												   header("Refresh:0; url=GestionFournisseur.php");
    												   }            									
    												 ?>   													
    												</td>
    												<?php echo'</tbody>';
