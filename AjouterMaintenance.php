                   ...
                   Ajouter Maintenance
                    ...
                    <div class="row">
                                ...
                                <div class="x_content">
                                    ...
                                    <form action="AjouterMaintenance1.php" class="form-horizontal form-label-left" novalidate>

                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Num maintenance <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input placeholder="Auto increment (Ne pas saisir)" id="NumMaintenance" class="form-control col-md-7 col-xs-12"  name="NumMaintenance"  required="required" type="text">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="email">Num inventaire <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
												 <?php
               									 try
                									...
                									$reponse = $db->query('SELECT * FROM MATERIEL;');
                									?>
                									<select  id="NumInventaire" type="text" name="NumInventaire"  class="optional form-control col-md-7 col-xs-12">
                									<?php 
                									while ($donnees = $reponse->fetch(PDO::FETCH_ASSOC))
                									{
                									?>
                									<option><?php echo $donnees['NUMINVENTAIRE'];?></option>
                                        ...
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="email">Nom Mainteneur <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <?php
               									 try
                									...
                									$reponse = $db->query('SELECT * FROM MAINTENEUR;');
                									?>
                									<select  id="NomMainteneur" type="text" name="NomMainteneur"  class="optional form-control col-md-7 col-xs-12">
                									<?php 
                									while ($donnees = $reponse->fetch(PDO::FETCH_ASSOC))
                									{
                									?>
                									<option value="NomMainteneur"><?php echo $donnees['NOMMAINTENEUR'];?></option>
                                        ...
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="number">Date d'envoie <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input  id="date" name="DateEnvoieMaint" required="required"  class="form-control col-md-7 col-xs-12" placeholder="AAAA-MM-JJ">
                                            </div>
                                        </div>
                                       
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="email">Description de panne <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input  id="TypePanne" name="TypePanne"  required="required" class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
                                        
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="occupation">Type de maintenance <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select id="TypeMaintenance"  name="TypeMaintenance"  class="optional form-control col-md-7 col-xs-12">
