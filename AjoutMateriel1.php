                    ...
                    <nav class="" role="navigation">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li role="presentation" class="dropdown">
              				...
              				<!-- Ajouter Materiel -->
<form action="AjoutMateriel1.php">
	<table>

		<?php 
		$db = new MySQLDatabase("localhost", "parcinfo", "root", "");
		$row[] = $_GET["NumInventaire"];
		$row[] = $_GET["NomMarque"];
		$row[] = $_GET["NomF"];
		$row[] = $_GET["TypeMateriel"];
		$row[] = $_GET["SerialNumber"];
		$row[] = $_GET["PrixAchat"];
		$row[] = $_GET["DateAchat"];
		$row[] = $_GET["DureeGarantie"];
		$row[] = $_GET["Caracteristique"];
		$res = $db->insert($row, "Materiel");
		if($res){
?>
	...
	<?php 	
				 ...
				 header("Refresh:1; url=AjouterMateriel.php"); 
