                   ...
                   Ajouter Affectation
                    ...
                    <div class="row">
                                ...
                                <div class="x_content">
                                    ...
                                    <form action="AjouterAffectation1.php" class="form-horizontal form-label-left" novalidate>

                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Matricule Utilisateur<span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
												<?php
                									...
                									?>
                									<select  id="Matricule" type="numero" name="Matricule"  class="optional form-control col-md-7 col-xs-12">
                									<?php 
                                        ...
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Date debut d'affectation<span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="to" class="form-control col-md-7 col-xs-12"  name="DateDebAff"  required="required" type="text" placeholder="AAAA-MM-JJ">
                                            </div>
                                        </div>
										<div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Date fin d'affectation<span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="to" class="form-control col-md-7 col-xs-12"  name="DateFinAff"  required="required" type="text" placeholder="AAAA-MM-JJ">
                                            </div>
                                        </div>
