                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                            		...
                            		<form action="ListeAffectaion.php" name="search_form" method="post">
                                        ...
                                        <tbody>
                                          <?php
                								...
                								if(isset($_POST['search'])){
													...
													$sql .= "OR MATRICULE LIKE '%{$search_term}%' ";
													$sql .= "OR DATEDEBAFF LIKE '%{$search_term}%' ";
													$sql .= "OR DATEFINAFF LIKE '%{$search_term}%' ";
        										...
        										$reponse = $db->query($sql);
                									...
                									echo '<td>'.$donnees['DATEDEBAFF'].'</td>';
                									echo '<td>'.$donnees['DATEFINAFF'].'</td>';
                									
                									?>
                									
                									<td>
                									<form method="post" action="ListeAffectaion.php">
                									<input type="image" name="sup" value="<?php echo $donnees['MATRICULE']; ?>" src="images/del.png" />
                									</form>
                          							<td><?php echo '<a style="color:#0000FF;" href="ModifierAffectation.php?MATRICULE='.$donnees['MATRICULE'].'">'; ?> Modifier</a></td>
                									
                									
                									<?php
 													   if (isset($_POST['sup'])) {
    												   $db->query("DELETE  FROM AFFECTER WHERE MATRICULE=".$_POST['sup']);
    												   header("Refresh:0; url=ListeAffectaion.php");
    												   }            									
    												 ?>   													
    												</td>
    												<?php echo'</tbody>';
