                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="">
                            <?php
							$NUMINVENTAIRE = $_GET["NUMINVENTAIRE"];
							  ...
							  try
							     ...
							     catch(Exception $e)
							     {
							      ...
							      $result = $db->query("SELECT * FROM MATERIEL WHERE NUMINVENTAIRE = $NUMINVENTAIRE");
							...
							<div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">NomMarque<span class="required"/>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                            <input  class="form-control col-md-7 col-xs-12" name="NOMMARQUE" size="22" value="<?php echo ''.$affiche_commentaire["NOMMARQUE"].' 
							';?>" type="text"/ >
                            </div>
                            </div> 
							...
							<div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">TypeMateriel<span class="required"/>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                            <input  class="form-control col-md-7 col-xs-12" name="TYPEMATERIEL" size="22" value="<?php echo ''.$affiche_commentaire["TYPEMATERIEL"].' 
							';?>" type="text"/ >
                            </div>
                            </div>   
							
							<div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Serial number<span class="required"/>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                            <input  class="form-control col-md-7 col-xs-12" name="SERIALNUMBER" size="22" value="<?php echo ''.$affiche_commentaire["SERIALNUMBER"].' 
							';?>" type="text"/ >
                            </div>
                            </div>  
                            
                            <div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Prix Achat<span class="required"/>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                            <input  class="form-control col-md-7 col-xs-12" name="PRIXACHAT" size="22" value="<?php echo ''.$affiche_commentaire["PRIXACHAT"].' 
							';?>" type="text"/ >
                            </div>
                            </div>   
                            
                            <div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Date Achat<span class="required"/>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                            <input  class="form-control col-md-7 col-xs-12" name="DATEACHAT" size="22" value="<?php echo ''.$affiche_commentaire["DATEACHAT"].' 
							';?>" type="text"/ >
                            </div>
                            </div>   
                            
                            <div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Duree Garantie<span class="required"/>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                            <input  class="form-control col-md-7 col-xs-12" name="DUREEGARANTIE" size="22" value="<?php echo ''.$affiche_commentaire["DUREEGARANTIE"].' 
							';?>" type="text"/ >
                            </div>
                            </div>     
							 ...
							 <div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Caracteristique<span class="required"/>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                            <input  class="form-control col-md-7 col-xs-12" name="CARACTERISTIQUE" size="22" value="<?php echo ''.$affiche_commentaire["CARACTERISTIQUE"].' 
							';?>" type="text"/ >
                            </div>
                            </div> 
							...
							if(isset($_POST["Modifier"]))
								...
								$requete="UPDATE MATERIEL set NUMINVENTAIRE='$NUMINVENTAIRE',NOMMARQUE='$NOMMARQUE',NOMF='$NOMF',TYPEMATERIEL='$TYPEMATERIEL',SERIALNUMBER='$SERIALNUMBER',PRIXACHAT='$PRIXACHAT',DATEACHAT='$DATEACHAT',DUREEGARANTIE='$DUREEGARANTIE',CARACTERISTIQUE='$CARACTERISTIQUE' where NUMINVENTAIRE='$NUMINVENTAIRE'";
