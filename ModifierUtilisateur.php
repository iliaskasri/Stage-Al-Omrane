                ...
                <div class="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
							...
							$MATRICULE = $_GET["MATRICULE"];
							  ...
							  try
							     ...
							     catch(Exception $e)
							     {
							      ...
							      $result = $db->query("SELECT * FROM UTILISATEUR WHERE MATRICULE = $MATRICULE");
                            ...
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Matricule<span class="required"/>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                            <input  class="form-control col-md-7 col-xs-12" name="MATRICULE" size="22" value="<?php echo ''.$affiche_commentaire["MATRICULE"].'
							 ';?>" type="text"/ >
                            </div>
                            </div>
							
							<div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Nom poste<span class="required"/>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                            <input  class="form-control col-md-7 col-xs-12" name="NOMPOSTE" size="22" value="<?php echo ''.$affiche_commentaire["NOMPOSTE"].' 
							';?>" type="text"/ >
                            </div>
                            </div> 
							    
							<div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Nom<span class="required"/>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                            <input  class="form-control col-md-7 col-xs-12" name="NOM" size="22" value="<?php echo ''.$affiche_commentaire["NOM"].'
							 ';?>" type="text"/ >
                            </div>
                            </div>  
							 
							<div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Prenom<span class="required"/>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                            <input  class="form-control col-md-7 col-xs-12" name="PRENOM" size="22" value="<?php echo ''.$affiche_commentaire["PRENOM"].' 
							';?>" type="text"/ >
                            </div>
                            </div>   
							
							<div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Role<span class="required"/>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                            <input  class="form-control col-md-7 col-xs-12" name="ROLE" size="22" value="<?php echo ''.$affiche_commentaire["ROLE"].' 
							';?>" type="text"/ >
                            </div>
                            </div>  
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                            <input  class="form-control col-md-7 col-xs-12" name="TEL_" size="22" value="<?php echo ''.$affiche_commentaire["TEL_"].' 
							';?>" type="text"/ >
                            </div>
                            </div>   
							...
							if(isset($_POST["Modifier"]))
								...
								$requete="UPDATE UTILISATEUR set MATRICULE='$MATRICULE',NOMPOSTE='$NOMPOSTE',NOM='$NOM',PRENOM='$PRENOM',ROLE='$ROLE',TEL_='$TEL_',EMAIL='$EMAIL' where MATRICULE='$MATRICULE'";
